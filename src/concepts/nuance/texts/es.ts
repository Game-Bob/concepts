import type { NuanceTexts } from "../types";

export const NUANCE_ES_TEXTS = {
    hud: {
        defaultLeft: "Izquierda",
        defaultRight: "Derecha",
        hint: "Desliza para descubrir",
        sliderLabel: "Equilibrio entre extremos",
    },
    intro: {
        labelLeft: "VACÍO",
        labelRight: "OSCURIDAD",
        title: "MATIZ",
        descriptionFirst: "El mundo real está lleno de color.",
        descriptionSecond: "Los extremos son su ausencia.",
        leftTitle: "BLANCO",
        leftDescription: "Sin sombras. Sin dudas.",
        rightTitle: "NEGRO",
        rightDescription: "Sin luz. Sin esperanza.",
    },
    slides: [
        {
            id: "feminismo",
    ...
    outro: {
        firstLine: "El mundo quiere que elijas bando.",
        secondLine: "La verdadera revolución es negarse.",
        exit: "Salir del Bucle",
        left: "VACÍO",
        right: "OSCURIDAD",
    },
} as const satisfies NuanceTexts;
